...
import styles from "./VehiculoProveedor.module.css";
import Tabla from "../Tabla/Tabla";

function VehiculoProveedor() {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [documentos, setDocumentos] = useState([
    { id: 1, consecutivo: 1, proveedor: "FELIX", fecha_emision: "2024-01-10", fecha_vencimiento: "2024-08-27", estado: "Vigente" },
  ]);
  ...
  return (
    <div className={styles.container}>
      <h3 className={styles.title}>Proveedor</h3>
      ...
      {documentos.length > 0 ? (
        <Tabla
          datos={documentos}
          columnasOmitidas={["id"]}
          columnasVisibles={["consecutivo", "proveedor", "fecha_emision", "fecha_vencimiento","estado"]}
...
export default VehiculoProveedor;
